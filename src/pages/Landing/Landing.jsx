  ...
  return (
    <main className="flex-auto text-center text-amber-500  min-h-screen">
      <div>
        ...
        <h2 className='m-20 font-semibold rounded-sm border-0 bg-orange-600/[.45] hover:bg-orange-600/[.9] text-white/[.8] hover:text-rose-900/[.8]  text-5xl'>{user && 'lets look at some art'}</h2>
      </div>
    </main>
  )
}
