...
const Reviews = ({user}) => {
  ...
  return (
    <div className="flex-auto justify-center text-center min-h-screen">
      <h1 className="rounded-sm m-20 font-semibold text-6xl text-white/[.8] bg-red-800/[.45] hover:bg-red-800/[.7] hover:text-orange-500/[.9]"> <button onClick={() => {getArtData(rand)}} >behold</button> </h1>
